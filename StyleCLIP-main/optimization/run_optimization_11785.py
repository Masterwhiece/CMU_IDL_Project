...
def main(args):
    ...
    for i in pbar:
        ...
        im_loss = clip_loss(img_gen, img_orig)
        ...
        if args.mode == "edit":
            ...
            loss = c_loss + args.l2_lambda * l2_loss + args.im_lambda * im_loss
        else:
            loss = c_loss
...
if __name__ == "__main__":
    ...
    parser.add_argument("--im_lambda", type=float, default=0.1, help="weight of the CLIP image distance loss (used for editing only)")
